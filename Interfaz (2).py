...
etiqueta = tk.Label(ventana, text="HOLA MUNDO", bg="red", fg="blue", font=("Time New Roman", 16), width=20, height=2, anchor="center")
etiqueta.pack()

def cambiar_texto():
    etiqueta.config(text="MEJOR TEXTO")
...
boton3 = tk.Button(ventana, text="HABILITADO", state="disabled")
boton3.pack()

def cambiar_texto():
    etiqueta.config(text=" UNICO TEXTO")

ventana = tk.Tk()
etiqueta = tk.Label(ventana, text="Preciona para cambiar texto")
etiqueta.pack()

boton1 = tk.Button(ventana, text="SIGUIENTE", command=cambiar_texto)
boton1.pack()
...
etiqueta1 = tk.Label(marco1, text="ciudad 1")
etiqueta1.pack()
etiqueta3 = tk.Label(marco1, text="ciudad 1")
etiqueta3.pack()
...
boton = tk.Button(ventana, text="RECIBIR", command=obtener_seleccion)
boton.pack()
